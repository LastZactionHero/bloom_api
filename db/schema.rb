...
ActiveRecord::Schema.define(version: 20170428043429) do
  ...
  create_table "combination_templates", force: :cascade do |t|
  ...
  create_table "plants", force: :cascade do |t|
    ...
    t.string   "lighting"
    t.float    "similarity_index",   default: 0.0
    ...
    t.index ["lighting"], name: "index_plants_on_lighting", using: :btree
    ...
    t.index ["similarity_index"], name: "index_plants_on_similarity_index", using: :btree
