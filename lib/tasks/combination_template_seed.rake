  ...
  task seed: :environment do
    [
      ...
      [
        ...
        { permalink: 'foersters_feather_reed_grass', tooltip: 'Mid size grass used in massing or screening small objects', placement: :tall_back, area: 0.20 },
      ...
      [
        ...
        { permalink: 'big_ears_lambs_ear', tooltip: 'Short groundcover/perennial.  Interesting texture with muted color/non showy flowers', placement: :short_front, area: 0.25 }
      ],
      [
        { permalink: 'nordic_inkberry_holly', tooltip: 'Mid size evergreen shrub.  Good as a backdrop or can be trimmed into a hedge', placement: :lone, area: 0.30 },
      ...
      [
        { permalink: 'green_velvet_boxwood', tooltip: 'Small, evergreen shrub.  One of most popular shrubs', placement: :lone, area: 0.15 },
        ...
        { permalink: 'big_blue_lilac', tooltip: 'Short groundcover/perennial.  Lowest layer of planting', placement: :lone, area: 0.10 }
      ],
      [
        { permalink: 'double_knock_out_rose', tooltip: 'Deciduous shrub with showy flowers', placement: :lone_1, area: 0.35 },
        { permalink: 'little_henry_dwarf_virginia_sweetspire', tooltip: 'Small deciduous shrub with interesting blooms', placement: :tall_back, area: 0.20 },
        { permalink: 'stella_de_oro_dwarf_daylily', tooltip: 'Small, reblooming, low maintenance perennial', placement: :short_front, area: 0.15 }
      ],
      [
        { permalink: 'alberta_blue_dwarf_alberta_spruce', tooltip: 'Large, evergreen shrub, used mostly for height/shape in landscape', placement: :lone, area: 0.15 },
        { permalink: 'golden_sedum', tooltip: 'Small perennial with showy flowers and interesting texture', placement: :lone, area: 0.15 },
        { permalink: 'tiny_wine_ninebark', tooltip: 'Mid size deciduous shrub with showy flowers and interesting leaf color', placement: :lone, area: 0.55 }
      ],
      [
